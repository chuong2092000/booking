package project.eventpaymentservice.exec;
...
import project.eventpaymentservice.task.OutboxPaymentTask;
...
public class PaymentProducer {
    ...
    private final OutboxPaymentTask task;
    ...
    public void executeTask() {
        ...
        List<OutBoxDto> outboxes = paymentClient.getOutBoxes(50);
